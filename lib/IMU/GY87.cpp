...
bool GY87::init()
{
    ...
    I2Cdev::writeByte(MPU6050_DEFAULT_ADDRESS, MPU6050_RA_PWR_MGMT_1, 0x80); // 设备复位
    delayMicroseconds(WRITE_INTERVAL);
    I2Cdev::writeByte(MPU6050_DEFAULT_ADDRESS, MPU6050_RA_PWR_MGMT_1, 0x01); //设置设备时钟源
    delayMicroseconds(WRITE_INTERVAL);
    I2Cdev::writeByte(MPU6050_DEFAULT_ADDRESS, MPU6050_RA_CONFIG, MPU6050_DLPF_BW_42);    //低通滤波 acc: 44hz, gyro: 42hz
    delayMicroseconds(WRITE_INTERVAL);
