...
class Board
{
  public:
    ...
    virtual unsigned char pin_analog_read(unsigned char pin)=0;
    virtual void pin_analog_write(unsigned char pin, unsigned char level)=0;

    virtual void pwm_init(unsigned char khz)=0;
    virtual void pwm_init(unsigned char pin, unsigned char hz)=0;
